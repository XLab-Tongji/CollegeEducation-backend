...
public class MimeTypes {
    ...
    public static final String MIME_APPLICATION_RAR ="application/rar";
    public static final String MIME_APPLICATION_ZIP       = "application/zip";
    public static final String MIME_APPLICATION_X_GZIP      = "application/x-gzip";
    public static final String MIME_APPLICATION_GZIP      = "application/gzip";
    ...
    public static final String MIME_APPLICATION_TAR       = "application/tar";
    ...
    public static final String MIME_X_OFFICE = "application/x-tika-msoffice";
    ...
    static {
        mimeTypeMapping = new HashMap<String, String>(200) {
            ...
            }
            {
                ...
                put1("rar1", MIME_APPLICATION_RAR);
                put1("gzip1", MIME_APPLICATION_GZIP);
        ...
        validResourceMapping = new HashMap<String, String>() {
            private void put1(String key, String value) {
                if(put(key,value) != null) {
                    throw new IllegalArgumentException("Duplicated extension: " + key);
                }
